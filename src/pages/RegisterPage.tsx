      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="flex items-center space-x-2">
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${
                step === "email"
                  ...
                  : step === "verification" || step === "password"
            ...
            <div
              className={`w-16 h-1 rounded ${step === "verification" || step === "password" ? "bg-emerald-200" : "bg-gray-200"}`}
            />
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${
                step === "verification"
            ...
            <div
              className={`w-16 h-1 rounded ${step === "password" ? "bg-emerald-200" : "bg-gray-200"}`}
            />
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${
                step === "password" ? "bg-emerald-600 text-white" : "bg-gray-200 text-gray-400"
              }`}
            >
              3
            </div>
